...
public class WidaObjectServiceImpl implements WidaObjectService {
    ...
    private void addPropertiesToBaseItem(Properties properties, BaseItem baseItem) {
        ...
        if (propertyMap.get(PropertyIds.NAME) != null) {
            ...
            baseItem.setName((String) propertyData.getFirstValue());
            ...
            baseItem.setObjectTypeId((String) propertyData.getFirstValue());
            ...
            if (secondaryIds != null) {
                ...
                if (values != null && values.size() > 0) {
                    ...
                    baseItem.setSecondaryTypeIds(secondarySet);
                }
            }
        }
    }
    ...
    public String createDocument(String userName, Properties properties, String folderId, ContentStream contentStream,
        ...
        addPropertiesToBaseItem(properties, document);
    ...
    public String createFolder(String userName, Properties properties, String folderId, List<String> policies,
        ...
        addPropertiesToBaseItem(properties, folder);
     ...
     *
     * @param widaContentMetaDataService the wida content meta data service
     */
