...
<h1><img src="wida.gif" alt="wida bird" style="width:25px;height:25px;">  Wida Server</h1>



<p style="font-weight: bold">Your server is up and running.</p>
<p>The Wida server is a CMIS server based on Apache Chemistry OpenCMIS.</p>
