...
import de.elnarion.ddlutils.model.*;
...
public class WidaContentMetaDataStructureManager {
     ...
     *
     * @param paramTypeWithSubHierarchy the param type with sub hierarchy
     * @param ignoreTypeHierarchy       the ignore type hierarchy
     */
    @Lock(LockType.WRITE)
    @Transactional
     ...
     *
     * @param localTableName          the local table name
     * @param localColumnDefinition   the local column definition
     * @param foreignTableDefinition  the foreign table definition
     * @param foreignColumnDefinition the foreign column definition
     ...
     *
     * @param widaDatasource the wida datasource
     */
     ...
     * Drop tables.
     *
     * @param repoValue the repo value
     */
    @Transactional
    @TransactionAttribute(TransactionAttributeType.REQUIRED)
    @Lock(LockType.WRITE)
     ...
     *
     * @param id                    the id
     * @param typeToPropertyMapping the type to property mapping
     */
    @Transactional
    @TransactionAttribute(TransactionAttributeType.REQUIRED)
